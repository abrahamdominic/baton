...
export function IconMessageCircle(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconBranch(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconAlertCircle(props: P) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="10" />
...
export function IconGitPullRequest(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconGitCommit(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconZap(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconTerminal(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconExternalLink(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconChevronUp(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconCreditCard(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconSmartphone(props: P) {
  return (
    <svg {...base(props)}>
...
export function IconBuilding(props: P) {
  return (
    <svg {...base(props)}>
